...
pygame.mixer.init()
wrong_sound = pygame.mixer.Sound(r"C:\Users\chsun\Downloads\540476__scott0642__buzz-buzz.wav")
correct_sound = pygame.mixer.Sound(r"C:\Users\chsun\Downloads\421002__eponn__correct.wav")
game_over_sound = pygame.mixer.Sound(r"C:\Users\chsun\Downloads\433644__dersuperanton__game-over-sound.wav")
start_sound = pygame.mixer.Sound(r"C:\Users\chsun\Downloads\144033188-deep-male-voice-god-character-_1_.wav")

def play_sound():
        pygame.mixer.music.load(r"C:\Users\chsun\Downloads\641014__igorchagas__enigmatic-polyphony.wav")
